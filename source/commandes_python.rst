...
.. note::
    ...
    Les docstrings permettent de commenter sur plusieurs lignes, on peut s'en servir pour générer de la documentation de manière générale et des tooltips dans le cadre de fonctions et classes par exemple. 
